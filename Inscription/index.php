...
<body>about:blank#blocked
    <nav class="navbar has-background-primary" role="navigation" aria-label="main navigation">
        ...
        <?php
                ...
                else
                {
                    echo"
                    <div class='navbar-end'>
                        <a class='button is-primary has-background-primary-35' href=''>Inscription</a>
    ...
    <div class="app">
        <p class="title is-1">Inscription</p>

        <div class="form">
            <form action="../redirect/inscription.php" method="post">
                <div class="field">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="Password" name="confirm" id="confirm" placeholder="e.x Po2'1dz*8y#">
                    </div>
                </div>
